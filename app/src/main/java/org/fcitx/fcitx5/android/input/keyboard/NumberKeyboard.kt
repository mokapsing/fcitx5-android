    ...
    companion object {
        ...
        val Layout: List<List<KeyDef>> = listOf(
            listOf(
                ...
                NumPadKey("1", "1", 0xffb1, 30f, 0f),
                NumPadKey("2", "2", 0xffb2, 30f, 0f),
                NumPadKey("3", "3", 0xffb3, 30f, 0f),
            ...
            listOf(
                ...
                NumPadKey("4", "4", 0xffb4, 30f, 0f),
                NumPadKey("5", "5", 0xffb5, 30f, 0f),
                NumPadKey("6", "6", 0xffb6, 30f, 0f),
                MiniSpaceKey()
            ),
            listOf(
                NumPadKey("*", "*", 0xffaa, 23f, 0.15f, KeyDef.Appearance.Variant.Alternative),
                NumPadKey("7", "7", 0xffb7, 30f, 0f),
                NumPadKey("8", "8", 0xffb8, 30f, 0f),
                NumPadKey("9", "9", 0xffb9, 30f, 0f),
                BackspaceKey()
            ),
            listOf(
                LayoutSwitchKey("ABC", "ABC", TextKeyboard.Name),
                ...
                NumPadKey("0", "0", 0xffb0, 30f, 0.23334f),
                SymbolKey("=", "=", 0.13333f),
